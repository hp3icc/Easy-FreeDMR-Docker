...
#sed -i "s/meta name=\"description.*/meta name=\"description\" content=\"Copyright (c) 2016-22.The Regents of the K0USY Group. All rights reserved. Version OA4DOA 2022 (v270422)\">/g" /etc/freedmr/hbmon/html/*.php
cat > /etc/freedmr/hbmon/templates/main_table2.html  <<- "EOF"
